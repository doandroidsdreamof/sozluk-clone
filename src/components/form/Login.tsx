...
import { Input } from "~/components/elements/index";
          ...
          <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            <Form className="mx-auto max-w-lg rounded-lg border border-input-border-light bg-bg-secondary-light dark:border-input-border-dark dark:bg-bg-secondary-dark ">
              <div className="flex flex-col gap-4 p-4 md:p-8 ">
                ...
                <button className="block rounded-md bg-brandGreen-800 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-brandGreen-700 focus-visible:ring  md:text-base">
                  Log in
                </button>
                ...
                <button className="flex items-center justify-center gap-2 rounded-md bg-blue-600 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-blue-300 transition duration-100 hover:bg-blue-500 focus-visible:ring active:bg-blue-700 md:text-base">
                  <svg
                ...
                <button className="flex items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-8 py-3 text-center text-sm font-semibold text-gray-800 outline-none ring-gray-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:text-base">
                  <svg
                    className="h-5 w-5 shrink-0"
                    width="24"
                    height="24"
              ...
              <div className="flex items-center justify-center  p-4">
                <p className="text-center text-sm text-gray-500">
                  ...
                  >
                    <span className="text-brandGreen-300 transition duration-100 hover:text-brandGreen-200 ">
                      Register
                    </span>
                  </Link>
                </p>
