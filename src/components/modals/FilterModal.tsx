        ...
        <Dialog as="div" className="relative z-[2000]" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto ">
            <div className="flex min-h-full   items-start justify-center p-3 text-center md:p-4 md:px-2 lg:-translate-x-6 lg:px-0">
              ...
              >
                <Dialog.Panel className="relative  top-14 flex   min-h-fit  w-nintyEight -translate-x-1   transform    rounded-md bg-white p-4  align-middle  shadow-xl transition-all dark:bg-bg-alt-dark md:top-10 lg:w-[38rem]">
