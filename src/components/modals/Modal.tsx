      ...
      <Transition appear show={isOpen}>
        ...
        >
          ...
          <div className="fixed inset-0 grid h-full w-full place-content-center  px-4 sm:px-12 ">
            ...
            >
              <Dialog.Panel className="flex  w-full  min-w-[25rem]  transform flex-col overflow-hidden rounded-md border   border-input-border-light bg-bg-secondary-light align-middle  shadow-xl  transition-all dark:border-input-border-dark dark:bg-bg-secondary-dark sm:w-[30rem]">
