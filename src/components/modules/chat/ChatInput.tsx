...
const ChatInput = () => {
  return (
    <div className="flex  w-full   flex-row items-center  bg-white  px-4 shadow-md ">
      ...
      <div className="ml-4">
        <button className="sbui-btn-primary dark mb-2.5  ml-auto mt-3 flex  max-w-fit cursor-pointer flex-row-reverse items-center gap-x-2  rounded-md bg-brandGreen-800  px-4 py-1.5 text-sm font-medium text-white hover:bg-brandGreen-600 dark:hover:bg-brandGreen-900">
          Send
          <BsSend size={13} />
        </button>
      </div>
